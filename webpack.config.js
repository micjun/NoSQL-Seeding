...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: "./client/index.html", //yes, htmlWebpack only works in development// index html is placed in root in RAM because it is a feature of setting the mode as development.
    }),
  ],
  resolve: {
